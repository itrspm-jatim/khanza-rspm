...
public final class RMDataResumePasien extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        jLabel13.setBounds(0, 590, 240, 23);
    ...
    */
    ...
    private void isKeluhan() {
        ...
        try {
            ps=koneksi.prepareStatement(
                    "SELECT keluhan, pemeriksaan FROM pemeriksaan_ralan WHERE no_rawat ='"+TNoRw.getText()+"'");
            try {
                rs=ps.executeQuery();
                while (rs.next()) {
            ...
            if (sb.length() > 0) {
                sb.append(", "); // tambahkan koma jika ada data sebelumnya
            }
            sb.append(rKeluhan).append(", ").append(rPemeriksaan);
            Keluhan.setText(sb.toString());
        }
            } catch (Exception e) {
                System.out.println("Notif : "+e);
            } finally{
    ...
    private void isObat2an() {
        ...
        try {
            ps=koneksi.prepareStatement(
                    "SELECT instruksi FROM pemeriksaan_ralan WHERE no_rawat ='"+TNoRw.getText()+"'");
            try {
                rs=ps.executeQuery();
                while (rs.next()) {
            ...
            sb.append(rInstruksi);
            Obat2an.setText(sb.toString());
        }
            } catch (Exception e) {
                System.out.println("Notif : "+e);
            } finally{
