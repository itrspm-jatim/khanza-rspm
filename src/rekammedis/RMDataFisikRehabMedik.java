 ...
 * @author perpustakaan
 */
public final class RMDataFisikRehabMedik extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public RMDataFisikRehabMedik(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        
        tabMode=new DefaultTableModel(null,new Object[]{
            "Tgl.Rawat","No.Rawat","No.RM","Nama Pasien","Kode Dokter","Dokter Penanggung Jawab","Anamesa",
            "Pemeriksaan Uji Fungsi","Pemeriksaan penunjang","Diagnosa Utama","ICD10 Utama","Diagnosa Sekunder 1",
            ...
            "Prosedur Sekunder 1","ICD9 Sek1","Prosedur Sekunder 2","ICD9 Sek2","Prosedur Sekunder 3","ICD9 Sek3","Anjuran","Evaluasi","Suspek Penyakit"
        }){
        ...
        anamesa.setDocument(new batasInput((int)2000).getKata(anamesa));
        fisikujifungsi.setDocument(new batasInput((int)2000).getKata(fisikujifungsi));
        ...
        anjuran.setDocument(new batasInput((int)2000).getKata(anjuran));
        ...
        carikeluhan.addWindowListener(new WindowListener() {
            ...
            public void windowClosed(WindowEvent e) {
                if(carikeluhan.getTable().getSelectedRow()!= -1){
                    anamesa.append(carikeluhan.getTable().getValueAt(carikeluhan.getTable().getSelectedRow(),2).toString()+", ");
        ...
        caripemeriksaan.addWindowListener(new WindowListener() {
            ...
            public void windowClosed(WindowEvent e) {
                if(caripemeriksaan.getTable().getSelectedRow()!= -1){
                    anamesa.append(caripemeriksaan.getTable().getValueAt(caripemeriksaan.getTable().getSelectedRow(),2).toString()+", ");
                    anamesa.requestFocus();
                }
            }
            @Override
        ...
        carilaborat.addWindowListener(new WindowListener() {
            ...
            public void windowClosed(WindowEvent e) {
                if(carilaborat.getTable().getSelectedRow()!= -1){
                    evaluasi.append(carilaborat.getTable().getValueAt(carilaborat.getTable().getSelectedRow(),2).toString()+", ");
    ...
    private void initComponents() {
        ...
        anamesa = new widget.TextArea();
        jLabel5 = new widget.Label();
        jLabel8 = new widget.Label();
        scrollPane3 = new widget.ScrollPane();
        fisikujifungsi = new widget.TextArea();
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Data Fisik Rehab Medik ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 50, 50))); // NOI18N
        internalFrame1.setFont(new java.awt.Font("Tahoma", 2, 12)); // NOI18N
        internalFrame1.setMinimumSize(new java.awt.Dimension(653, 169));
        internalFrame1.setName("internalFrame1"); // NOI18N
        internalFrame1.setPreferredSize(new java.awt.Dimension(462, 653));
        ...
        scrollInput.setPreferredSize(new java.awt.Dimension(102, 792));
        ...
        jLabel25.setBounds(20, 330, 145, 23);
        ...
        DiagnosaSekunder2.setBounds(170, 330, 520, 23);

        jLabel26.setText("Diagnosa Sekunder 3 :");
        jLabel26.setName("jLabel26"); // NOI18N
        FormInput.add(jLabel26);
        jLabel26.setBounds(20, 360, 145, 23);
        ...
        DiagnosaUtama.setBounds(170, 270, 520, 23);

        jLabel27.setText("Diagnosa Utama :");
        jLabel27.setName("jLabel27"); // NOI18N
        FormInput.add(jLabel27);
        jLabel27.setBounds(20, 270, 145, 23);
        ...
        DiagnosaSekunder3.setBounds(170, 360, 520, 23);

        jLabel28.setText("Diagnosa Sekunder 4 :");
        jLabel28.setName("jLabel28"); // NOI18N
        FormInput.add(jLabel28);
        jLabel28.setBounds(20, 390, 145, 23);
        ...
        DiagnosaSekunder4.setBounds(170, 390, 520, 23);

        scrollPane2.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)));
        scrollPane2.setName("scrollPane2"); // NOI18N

        anamesa.setBorder(javax.swing.BorderFactory.createEmptyBorder(1, 1, 1, 1));
        anamesa.setColumns(20);
        anamesa.setRows(5);
        ...
        scrollPane2.setViewportView(anamesa);
        ...
        jLabel8.setText("Pemeriksaan Fisik Dan Uji Fungsi :");
        ...
        fisikujifungsi.setBorder(javax.swing.BorderFactory.createEmptyBorder(1, 1, 1, 1));
        fisikujifungsi.setColumns(20);
        fisikujifungsi.setRows(5);
        fisikujifungsi.setName("fisikujifungsi"); // NOI18N
        fisikujifungsi.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                fisikujifungsiKeyPressed(evt);
            }
        });
        scrollPane3.setViewportView(fisikujifungsi);
        ...
        jLabel10.setBounds(0, 610, 240, 23);
        ...
        scrollPane5.setBounds(250, 610, 541, 50);

        jLabel11.setText("Anjuran :");
        jLabel11.setName("jLabel11"); // NOI18N
        FormInput.add(jLabel11);
        jLabel11.setBounds(0, 550, 240, 23);
        ...
        scrollPane6.setBounds(250, 550, 541, 50);

        jLabel29.setText("Diagnosa Akhir :");
        jLabel29.setName("jLabel29"); // NOI18N
        FormInput.add(jLabel29);
        jLabel29.setBounds(20, 240, 97, 23);

        jLabel30.setText("Diagnosa Sekunder 1 :");
        jLabel30.setName("jLabel30"); // NOI18N
        FormInput.add(jLabel30);
        jLabel30.setBounds(20, 300, 145, 23);
        ...
        DiagnosaSekunder1.setBounds(170, 300, 520, 23);

        jLabel31.setText("Kode ICD :");
        jLabel31.setName("jLabel31"); // NOI18N
        FormInput.add(jLabel31);
        jLabel31.setBounds(550, 240, 210, 23);
        ...
        KodeDiagnosaUtama.setBounds(730, 270, 75, 23);
        ...
        KodeDiagnosaSekunder1.setBounds(730, 300, 75, 23);
        ...
        KodeDiagnosaSekunder2.setBounds(730, 330, 75, 23);
        ...
        KodeDiagnosaSekunder3.setBounds(730, 360, 75, 23);
        ...
        KodeDiagnosaSekunder4.setBounds(730, 390, 75, 23);

        jLabel32.setText("Prosedur Utama :");
        jLabel32.setName("jLabel32"); // NOI18N
        FormInput.add(jLabel32);
        jLabel32.setBounds(20, 420, 145, 23);
        ...
        ProsedurUtama.setBounds(170, 420, 520, 23);
        ...
        KodeProsedurUtama.setBounds(730, 420, 75, 23);
        ...
        ProsedurSekunder1.setBounds(170, 450, 520, 23);

        jLabel33.setText("Prosedur Sekunder 1 :");
        jLabel33.setName("jLabel33"); // NOI18N
        FormInput.add(jLabel33);
        jLabel33.setBounds(20, 450, 145, 23);
        ...
        KodeProsedurSekunder1.setBounds(730, 450, 75, 23);

        jLabel34.setText("Prosedur Sekunder 2 :");
        jLabel34.setName("jLabel34"); // NOI18N
        FormInput.add(jLabel34);
        jLabel34.setBounds(20, 480, 145, 23);
        ...
        ProsedurSekunder2.setBounds(170, 480, 520, 23);
        ...
        KodeProsedurSekunder2.setBounds(730, 480, 75, 23);
        ...
        KodeProsedurSekunder3.setBounds(730, 510, 75, 23);
        ...
        ProsedurSekunder3.setBounds(170, 510, 520, 23);

        jLabel35.setText("Prosedur Sekunder 3 :");
        jLabel35.setName("jLabel35"); // NOI18N
        FormInput.add(jLabel35);
        jLabel35.setBounds(20, 510, 145, 23);
        ...
        suspek.setBounds(250, 670, 100, 23);

        jLabel12.setText("Suspek Penyakit Akibat Kerja :");
        jLabel12.setName("jLabel12"); // NOI18N
        FormInput.add(jLabel12);
        jLabel12.setBounds(20, 670, 220, 23);
        ...
        BtnDokter3.setBounds(210, 640, 28, 23);
        ...
        BtnDokter4.setBounds(210, 570, 28, 23);
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        ...
        }else if(anamesa.getText().equals("")){
            Valid.textKosong(anamesa,"Keluhan utama riwayat penyakit yang postif");
        }else if(fisikujifungsi.getText().equals("")){
            Valid.textKosong(fisikujifungsi,"Jalannya penyakit selama perawatan");
        }else if(DiagnosaUtama.getText().equals("")){
            Valid.textKosong(DiagnosaUtama,"Diagnosa Utama");
        }else{
            if(Sequel.menyimpantf("fisik_rehab_medik","?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?","No.Rawat",26,new String[]{
    ...
    private void DiagnosaUtamaKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_DiagnosaUtamaKeyPressed
       Valid.pindah(evt,evaluasi,KodeDiagnosaUtama);
    ...
    private void KodeProsedurSekunder3KeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_KodeProsedurSekunder3KeyPressed
        Valid.pindah(evt,ProsedurSekunder3,anjuran);
    ...
    private void suspekKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_suspekKeyPressed
        Valid.pindah(evt, KodeDokter, anamesa);
    ...
    private void fisikujifungsiKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_fisikujifungsiKeyPressed
        if(evt.getKeyCode()==KeyEvent.VK_ENTER){
            if(evt.isShiftDown()){
                PemeriksaanPenunjang.requestFocus();
            }
    ...
    }//GEN-LAST:event_fisikujifungsiKeyPressed
    ...
    private void MnLaporanResumeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnLaporanResumeActionPerformed
        if(tbObat.getSelectedRow()>-1){
            ...
            Valid.MyReport("rptFisikRehabMedik.jasper","report","::[ Laporan Fisik Rehab Medik ]::",param);
        }
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            RMDataFisikRehabMedik dialog = new RMDataFisikRehabMedik(new javax.swing.JFrame(), true);
    ...
    private widget.TextArea anamesa;
    private widget.TextArea anjuran;
    private widget.TextArea evaluasi;
    private widget.TextArea fisikujifungsi;
    ...
    public void tampil() {
        ...
        try{
            if(TCari.getText().equals("")){
                ps=koneksi.prepareStatement(
                    "select reg_periksa.tgl_registrasi,reg_periksa.no_rawat,reg_periksa.no_rkm_medis,pasien.nm_pasien, "+
                    "fisik_rehab_medik.kd_dokter,dokter.nm_dokter,fisik_rehab_medik.anamesa,fisik_rehab_medik.fisik_ujifungsi, "+
                    "fisik_rehab_medik.pemeriksaan_penunjang,fisik_rehab_medik.diagnosa_utama,fisik_rehab_medik.kd_diagnosa_utama, "+
                    ...
                    "fisik_rehab_medik.prosedur_sekunder2,fisik_rehab_medik.kd_prosedur_sekunder2,fisik_rehab_medik.prosedur_sekunder3,fisik_rehab_medik.kd_prosedur_sekunder3,fisik_rehab_medik.anjuran, "+
                    "fisik_rehab_medik.evaluasi,fisik_rehab_medik.suspek from fisik_rehab_medik inner join reg_periksa on fisik_rehab_medik.no_rawat=reg_periksa.no_rawat  "+
                    "inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis inner join dokter on fisik_rehab_medik.kd_dokter=dokter.kd_dokter "+
                ...
                ps=koneksi.prepareStatement(
                    ...
                    "(reg_periksa.no_rkm_medis like ? or pasien.nm_pasien like ? or fisik_rehab_medik.kd_dokter like ? or "+
                    "dokter.nm_dokter like ? or fisik_rehab_medik.suspek like ? or fisik_rehab_medik.kd_diagnosa_utama like ? or "+
                    "fisik_rehab_medik.diagnosa_utama like ? or fisik_rehab_medik.prosedur_utama like ? or reg_periksa.no_rawat like ? or "+
                    "fisik_rehab_medik.kd_prosedur_utama like ?) order by reg_periksa.tgl_registrasi");
            }
            try {
                if(TCari.getText().equals("")){
                ...
                while(rs.next()){
                    tabMode.addRow(new String[]{
                        ...
                        rs.getString("kd_dokter"),rs.getString("nm_dokter"),rs.getString("anamesa"),
                        rs.getString("fisik_ujifungsi"),rs.getString("pemeriksaan_penunjang"),rs.getString("diagnosa_utama"),
                        ...
                        rs.getString("kd_prosedur_sekunder3"),rs.getString("anjuran"),rs.getString("evaluasi") ,rs.getString("suspek")
                    });
                }
            } catch (Exception e) {
                System.out.println("Notif : "+e);
    ...
    private void getData() {
        if(tbObat.getSelectedRow()!= -1){
            ...
            anamesa.setText(tbObat.getValueAt(tbObat.getSelectedRow(),6).toString()); 
            fisikujifungsi.setText(tbObat.getValueAt(tbObat.getSelectedRow(),7).toString());   
            ...
            anjuran.setText(tbObat.getValueAt(tbObat.getSelectedRow(),27).toString());
            evaluasi.setText(tbObat.getValueAt(tbObat.getSelectedRow(),28).toString());
            suspek.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(),29).toString());  
        }
    }
    ...
    private void isForm(){
        if(ChkInput.isSelected()==true){
            ...
            PanelInput.setPreferredSize(new Dimension(WIDTH,this.getHeight()-182));
