...
import rekammedis.MasterCariTemplateRacikan;
...
public final class DlgRawatJalan extends javax.swing.JDialog {
    ...
    private PreparedStatement ps,ps2,ps3,ps4,ps5,ps6,ps7,pstindakan,psset_tarif,psrekening,psresep,pscarikapasitas;
    private ResultSet rs,rstindakan,rsset_tarif,rsrekening,rsobat,carikapasitas,rs7;
    ...
    private String aktifkanparsial="no",kode_poli="",kd_pj="",poli_ralan="No",cara_bayar_ralan="No",TANGGALMUNDUR="yes",
            ...
            Beban_Jasa_Menejemen_Tindakan_Ralan="",Utang_Jasa_Menejemen_Tindakan_Ralan="",resep="",noresep="";
        ...
        soapterakhir.addWindowListener(new WindowListener() {
            ...
            public void windowClosed(WindowEvent e) {
                if(soapterakhir.getTable().getSelectedRow()!= -1){   
                    ...
                    TTensi.setText(soapterakhir.getTable().getValueAt(soapterakhir.getTable().getSelectedRow(),9).toString());
                    TBerat.setText(soapterakhir.getTable().getValueAt(soapterakhir.getTable().getSelectedRow(),10).toString());
                    TTinggi.setText(soapterakhir.getTable().getValueAt(soapterakhir.getTable().getSelectedRow(),11).toString());
                    TRespirasi.setText(soapterakhir.getTable().getValueAt(soapterakhir.getTable().getSelectedRow(),12).toString());
                    TNadi.setText(soapterakhir.getTable().getValueAt(soapterakhir.getTable().getSelectedRow(),13).toString());
                    SpO2.setText(soapterakhir.getTable().getValueAt(soapterakhir.getTable().getSelectedRow(),14).toString());
                    TGCS.setText(soapterakhir.getTable().getValueAt(soapterakhir.getTable().getSelectedRow(),15).toString());
                    LingkarPerut.setText(soapterakhir.getTable().getValueAt(soapterakhir.getTable().getSelectedRow(),16).toString());
                    TAlergi.setText(soapterakhir.getTable().getValueAt(soapterakhir.getTable().getSelectedRow(),17).toString());
    ...
    private void initComponents() {
        ...
        BtnResepFavorit = new widget.Button();
        BtnTemplatePemeriksaan = new widget.Button();
        BtnCopyResep2 = new widget.Button();
        BtnCopyResepKeIns = new javax.swing.JButton();
        ...
        BtnValidasiSBAR = new widget.Button();
        ...
        btnPasien.setToolTipText("Alt+6 (Cari RM)");
        ...
        BtnSeekPegawai.setToolTipText("Cari Pegawai");
        ...
        Btn5Soap.setToolTipText("5 SOAP");
        ...
        BtnResepFavorit.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/190.png"))); // NOI18N
        BtnResepFavorit.setMnemonic('4');
        BtnResepFavorit.setToolTipText("Template Resep");
        BtnResepFavorit.setName("BtnResepFavorit"); // NOI18N
        BtnResepFavorit.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnResepFavoritActionPerformed(evt);
            }
        });
        panelGlass12.add(BtnResepFavorit);
        BtnResepFavorit.setBounds(510, 160, 28, 23);
        ...
        BtnCopyResep2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/190.png"))); // NOI18N
        BtnCopyResep2.setMnemonic('4');
        BtnCopyResep2.setToolTipText("Copy Resep");
        ...
        BtnCopyResep2.setBounds(480, 160, 28, 23);

        BtnCopyResepKeIns.setText("Copy Instruksi");
        BtnCopyResepKeIns.setToolTipText("Copy Instruksi dari Resep");
        BtnCopyResepKeIns.setName("BtnCopyResepKeIns"); // NOI18N
        BtnCopyResepKeIns.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnCopyResepKeInsActionPerformed(evt);
            }
        });
        panelGlass12.add(BtnCopyResepKeIns);
        BtnCopyResepKeIns.setBounds(910, 140, 105, 22);
        ...
        BtnValidasiSBAR.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/item.png"))); // NOI18N
        BtnValidasiSBAR.setText("Verifikasi SBAR");
        BtnValidasiSBAR.setFocusPainted(false);
        BtnValidasiSBAR.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        BtnValidasiSBAR.setGlassColor(new java.awt.Color(255, 255, 255));
        BtnValidasiSBAR.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        BtnValidasiSBAR.setMargin(new java.awt.Insets(1, 1, 1, 1));
        BtnValidasiSBAR.setName("BtnValidasiSBAR"); // NOI18N
        BtnValidasiSBAR.setPreferredSize(new java.awt.Dimension(190, 23));
        BtnValidasiSBAR.setRoundRect(false);
        BtnValidasiSBAR.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnValidasiSBARActionPerformed(evt);
            }
        });
        FormMenu.add(BtnValidasiSBAR);
        ...
        BtnUjiFungsiFisikRehabMedik.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/item.png"))); // NOI18N
        BtnUjiFungsiFisikRehabMedik.setText("Uji Fungsi Fisik Rehab Medik");
        BtnUjiFungsiFisikRehabMedik.setFocusPainted(false);
        BtnUjiFungsiFisikRehabMedik.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        ...
        BtnUjiFungsiFisikRehabMedik.setName("BtnUjiFungsiFisikRehabMedik"); // NOI18N
    ...
    private void BtnKeluarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnKeluarActionPerformed
        ...
        try {
            // rspm
            String hasil = Sequel.cariIsi("select stts from reg_periksa where no_rawat=?", TNoRw.getText());
            if (Objects.equals(hasil, "Belum")) {
                int i = JOptionPane.showConfirmDialog(null, 
                    "Mau sekalian update status pasien sudah diperiksa ????", 
                    "Konfirmasi", JOptionPane.YES_NO_OPTION);

                if (i == JOptionPane.YES_OPTION) {
                    boolean updateBerhasil = Sequel.mengedittf("reg_periksa", "no_rawat=?", "stts=?", 2, new String[]{"Sudah", TNoRw.getText()});
...
private void BtnEditKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BtnEditKeyPressed
   ...
   // ----
    ...
    private void BtnCopyResepKeInsActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnCopyResepKeInsActionPerformed
        // rspm
        if(Sequel.cariInteger("select count(no_rawat) from resep_obat where no_rawat=?",TNoRw.getText())>0) {
            try {
                noresep=Sequel.cariIsi("select no_resep from resep_obat where no_rawat=? ORDER BY no_resep limit 1",TNoRw.getText());
                resep="\nResep : \n";
                ...
                try {
                    ...
                    while(rsobat.next()){
                        ...
                        try {
                            pscarikapasitas.setString(1,noresep);
                    ...
                    if(resep != null) {
                        TInstruksi.append(resep);
                        JOptionPane.showMessageDialog(null,"Resep telah tercopy ke instruksi");
                    } else {
                        JOptionPane.showMessageDialog(null,"resep kosong. hubungi IT");
                    }
            ...
            JOptionPane.showMessageDialog(null,"Belum ada resep di no. rawat ini");
        }
        // ------------------------
    }//GEN-LAST:event_BtnCopyResepKeInsActionPerformed

    private void BtnResepFavoritActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnResepFavoritActionPerformed
        // rspm
        if(TNoRw.getText().trim().equals("")){
            JOptionPane.showMessageDialog(null,"Maaf, Silahkan anda pilih dulu dengan menklik data pada table...!!!");
            TCari.requestFocus();
    ...
    }//GEN-LAST:event_BtnResepFavoritActionPerformed
    ...
    private void BtnValidasiSBARActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnValidasiSBARActionPerformed
        if(TNoRw.getText().trim().equals("") ){
            JOptionPane.showMessageDialog(null,"Maaf, Silahkan anda pilih dulu dengan menklik data pada table...!!!");
            TCari.requestFocus();
        }else{
            this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
            ValidasiSBAR valSbar=new ValidasiSBAR(null,false);
            valSbar.isCek();
            valSbar.emptTeks();
            valSbar.setNoRm(TNoRw.getText(),DTPCari2.getDate());
            valSbar.tampil();
            valSbar.setSize(internalFrame1.getWidth(),internalFrame1.getHeight());
            valSbar.setLocationRelativeTo(internalFrame1);
            valSbar.setVisible(true);
            this.setCursor(Cursor.getDefaultCursor());
        }
    }//GEN-LAST:event_BtnValidasiSBARActionPerformed
    ...
    */
    ...
    private javax.swing.JButton BtnCopyResepKeIns;
    ...
    private widget.Button BtnResepFavorit;
    ...
    private widget.Button BtnValidasiSBAR;
    ...
    public void isCek(){
        ...
        BtnResepFavorit.setEnabled(akses.gettemplate_pemeriksaan());
    ...
    private void inputResepFavorit() {
        MasterCariTemplateRacikan templateracikan=new MasterCariTemplateRacikan(null,false);
        templateracikan.isCek();
        templateracikan.setDokter(KdDok.getText(),Valid.SetTgl(DTPTgl.getSelectedItem()+""),cmbJam.getSelectedItem()+":"+cmbMnt.getSelectedItem()+":"+cmbDtk.getSelectedItem(),TNoRw.getText(),TNoRM.getText());
        templateracikan.tampil();
        templateracikan.setSize(internalFrame1.getWidth()-20,internalFrame1.getHeight()-20);
        templateracikan.setLocationRelativeTo(internalFrame1);
        templateracikan.setVisible(true);
    }
    ...
    private void simpan() {
        switch (TabRawat.getSelectedIndex()) {
                    ...
                    if(KdPeg.getText().trim().equals("")||TPegawai.getText().trim().equals("")){
                        ...
                        if(akses.getkode().equals("Admin Utama")){
                            if(Sequel.menyimpantf("pemeriksaan_ralan","?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?","Data",21,new String[]{
                                ...
                                if(akses.getkode().equals("Admin Utama")){
                                    if(Sequel.menyimpantf("resume_pasien","?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?","Data",26,new String[]{
                                TNoRw.getText(),KdPeg.getText(),TKeluhan.getText(),TPemeriksaan.getText(),"-","-",TPenilaian.getText(),"-","-","-",
                                "-","-","-","-","-","-","-","-","-","-",
                                "-","-","-","-","Hidup",TInstruksi.getText()})==true) {
                                        JOptionPane.showMessageDialog(null,"Resume tersimpan sesuai SOAPIE");
                                    }
                                } else {
                                    JOptionPane.showMessageDialog(null,"Resume tersimpan otomatis jika anda dokter");
                                }
                                    tabModePemeriksaan.addRow(new Object[]{
                            ...
                            if(akses.getkode().equals(KdPeg.getText())){
                                if(Sequel.menyimpantf("pemeriksaan_ralan","?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?","Data",21,new String[]{
                                    ...
                                    SpO2.getText(),TGCS.getText(),cmbKesadaran.getSelectedItem().toString(),TKeluhan.getText(),TPemeriksaan.getText(),TAlergi.getText(),
                                    LingkarPerut.getText(),TindakLanjut.getText(),TPenilaian.getText(),TInstruksi.getText(),TEvaluasi.getText(),KdPeg.getText()})==true){
                                    if(Sequel.cariInteger("select count(kd_dokter) from dokter where kd_dokter=?",KdPeg.getText())>0 && !KdPeg.getText().equals("D0000101") ){
                                        if(Sequel.menyimpantf("resume_pasien","?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?","Data",26,new String[]{
                                        TNoRw.getText(),KdPeg.getText(),TKeluhan.getText(),TPemeriksaan.getText(),"-","-",TPenilaian.getText(),"-","-","-",
                                        "-","-","-","-","-","-","-","-","-","-",
                                        "-","-","-","-","Hidup",TInstruksi.getText()})==true) {
            ...
            case 7:
                ...
                break;
            case 8:
                if((!TSituation.getText().trim().equals(""))||(!TBackground.getText().trim().equals(""))||(!TAssesment.getText().trim().equals(""))||(!TRecommendation.getText().trim().equals(""))){
                    if(KdPeg2.getText().trim().equals("")||TPegawai2.getText().trim().equals("")){
                        Valid.textKosong(KdPeg2,"Dokter/Paramedis masih kosong...!!");
                    }else{
                         JOptionPane.showMessageDialog(null,"Maaf. menu ini masih dalam pengembangan");
                        if(akses.getkode().equals("Admin Utama")){
