...
public final class DlgKasirRalan extends javax.swing.JDialog {
    ...
    public DlgKasirRalan(java.awt.Frame parent, boolean modal) {
        ...
        tabModekasir=new DefaultTableModel(null,new String[]{
            ...
            "Jam","No.Reg","Status Bayar","Stts Poli","Kd PJ","Kd Poli","No.Telp Pasien","No. SEP","SKDP Hari Ini","SKDP Selanjutnya","Tgl. Surat Kontrol Selanjutnya"}){
    ...
    private void initComponents() {
        ...
        MnUjiFisikRehabMedik = new javax.swing.JMenuItem();
        ...
        MnUjiFisikRehabMedik.setBackground(new java.awt.Color(255, 255, 254));
        MnUjiFisikRehabMedik.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        MnUjiFisikRehabMedik.setForeground(new java.awt.Color(50, 50, 50));
        MnUjiFisikRehabMedik.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/category.png"))); // NOI18N
        MnUjiFisikRehabMedik.setText("Uji Fungsi Fisik Rehab Medik");
        MnUjiFisikRehabMedik.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        MnUjiFisikRehabMedik.setHorizontalTextPosition(javax.swing.SwingConstants.RIGHT);
        MnUjiFisikRehabMedik.setName("MnUjiFisikRehabMedik"); // NOI18N
        MnUjiFisikRehabMedik.setPreferredSize(new java.awt.Dimension(210, 26));
        MnUjiFisikRehabMedik.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                MnUjiFisikRehabMedikActionPerformed(evt);
            }
        });
...
private void MnDataPemberianObatActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnDataPemberianObatActionPerformed
    ...
    private void MnUjiFisikRehabMedikActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnUjiFisikRehabMedikActionPerformed
        if(tabModekasir.getRowCount()==0){
            JOptionPane.showMessageDialog(null,"Maaf, table masih kosong...!!!!");
            //TNoReg.requestFocus();
        }else if(TNoRw.getText().trim().equals("")){
    ...
    }//GEN-LAST:event_MnUjiFisikRehabMedikActionPerformed
    ...
    */
    ...
    private javax.swing.JMenuItem MnUjiFisikRehabMedik;
            ...
            try{
                ...
                while(rskasir.next()){
                    tabModekasir.addRow(new String[] {
                        ...
                        rskasir.getString("skdp_hari_ini"),rskasir.getString("skdp_selanjutnya"),rskasir.getString("tgl_surkon_selanjutnya")
                    });
                }                
            } catch(Exception e){
    ...
    private void initKasirRalan() {
        ...
        MnDataRM.add(MnUjiFisikRehabMedik);
