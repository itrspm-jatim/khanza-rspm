...
public final class akses {
    ...
    private static boolean aktif=false,admin=false,user=false,vakum=false,aplikasi=false,penyakit=false,obat_penyakit=false,dokter=false,jadwal_praktek=false,petugas=false,pasien=false,registrasi=false,
            ...
            catatan_observasi_ventilator=false,catatan_anestesi_sedasi=false,rspm_perencanaan_pemulangan_igd=false;
        ...
        try {        
                ...
                try {
                    ...
                    if(rs.getRow()>=1){
                        ...
                        akses.rspm_perencanaan_pemulangan_igd=true;
                        ...
                        akses.rspm_perencanaan_pemulangan_igd=rs2.getBoolean("rspm_perencanaan_pemulangan_igd");
                        ...
                        akses.rspm_perencanaan_pemulangan_igd=false;
                    }
                } catch (Exception e) {
    ...
    public static boolean getperencanaan_pemulangan_igd(){return akses.rspm_perencanaan_pemulangan_igd;}
}   
